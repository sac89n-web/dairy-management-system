...
namespace Dairy.Application
{
    ...
    public class DashboardService : IDashboardService
    {
        ...
        public async Task<DashboardMetrics> GetMetricsAsync()
        {
            ...
            metrics.AvgSnf = await connection.QuerySingleOrDefaultAsync<decimal>(
        ...
        public async Task<IEnumerable<RateAnalytics>> GetRateAnalyticsAsync()
        {
            ...
            return await connection.QueryAsync<RateAnalytics>(@"
                SELECT 
        ...
        public async Task<IEnumerable<QualityTrend>> GetQualityTrendsAsync()
        {
            ...
            return await connection.QueryAsync<QualityTrend>(@"
                SELECT 
